================================================================================
MWS ERP v3.0 – Complete Business Management System
================================================================================
...
▶️ To run: Simply open the index.html file in any modern web browser.
...
Sales ERP is a full-featured, browser-based Enterprise Resource Planning
system designed for small to medium businesses. It helps you manage:
...
portable and requiring no external database.
...
9. WEBHOOK SYSTEM
   ...
   • Event types: sale.created, sale.updated, sale.deleted,
...
1.  GOOGLE SIGN-IN (Mandatory)
    ...
    e) Copy your Client ID
    f) Paste it in Settings → Google Client ID

2.  EMAILJS (For Email Invoicing) – Optional
    ────────────────────────────────────────────────────────────────────────────
    a) Sign up at https://www.emailjs.com
    b) Create a new email service (Gmail, Outlook, etc.)
    c) Create an email template for invoices
    d) Copy your:
       - Public Key (from Account → API Keys)
       - Service ID
       - Template ID
    e) Paste them in Settings → EmailJS Configuration

3.  WEBHOOKS – Optional
    ────────────────────────────────────────────────────────────────────────────
    a) Set up a webhook endpoint on your server
    b) Enter the URL in the Webhooks section
    c) Select events to send
    d) (Optional) Set a secret for verification
    e) Test the webhook using the "Test Webhook" button
...
┌─────────────────────────────────────────────────────────────────────────────┐
│  products      │ Array of { id, name, sku, price, stock, category,        │
│                │   description, hsn }                                      │
├─────────────────────────────────────────────────────────────────────────────┤
│  sales         │ Array of { id, orderNumber, customerId, date, items,     │
│                │   total, status }                                         │
├─────────────────────────────────────────────────────────────────────────────┤
│  purchases     │ Array of { id, poNumber, supplierId, date, items,        │
│                │   total, status }                                         │
├─────────────────────────────────────────────────────────────────────────────┤
│  customers     │ Array of { id, name, email, phone, company, gst, address }│
├─────────────────────────────────────────────────────────────────────────────┤
│  suppliers     │ Array of { id, name, email, phone, company, gst, address }│
├─────────────────────────────────────────────────────────────────────────────┤
│  company       │ { name, address, phone, email, gst, website }             │
├─────────────────────────────────────────────────────────────────────────────┤
│  settings      │ { currency, useRealTime, rates, lastUpdate,               │
│                │   googleClientId, emailjsPublic, emailjsService,          │
│                │   emailjsTemplate, cgstRate, sgstRate, invoiceTerms,      │
│                │   invoiceFooter }                                         │
├─────────────────────────────────────────────────────────────────────────────┤
